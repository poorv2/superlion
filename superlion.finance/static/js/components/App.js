...
class App extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            defiName: 'SuperLion',
            defiUrl: 'http://superlion.finance/',
    ...
    refreshPools = () => {
        ...
        //fetch('https://superlion.finance/pools.php')

        //console.log('refreshPools');

        //let poolsUrl = 'https://superlion.finance/pools-v2.php';
        //let poolsUrl = 'https://defi.cristian.ovh/pools-v2.php';
        //let poolsUrl = 'https://defi.cristian.ovh/pools-wbnb.php';
        //let poolsUrl = 'https://superlion.finance/pools-v4.json';
        let poolsUrl = 'https://superlion.finance/pwbnb.json';
