    ...
    return function o(s, a, u) {
        ...
        9: [function(A, e, t) {
            ! function(e, t) {
                ...
                m.isBN = function(e) {
                    ...
                    var s = 0;
                    if ("be" === r)
                        for (o = e.length - 1, n = 0; 0 <= o; o -= 3) {
                            i = e[o] | e[o - 1] << 8 | e[o - 2] << 16, this.words[n] |= i << s & 67108863, this.words[n + 1] = i >>> 26 - s & 67108863, 26 <= (s += 24) && (s -= 26, n++);
                        } else if ("le" === r)
                            for (n = o = 0; o < e.length; o += 3) {
                                i = e[o] | e[o + 1] << 8 | e[o + 2] << 16, this.words[n] |= i << s & 67108863, this.words[n + 1] = i >>> 26 - s & 67108863, 26 <= (s += 24) && (s -= 26, n++);
                            }
                    return this.strip();
                    ...
                    for (var i = 0, n = e.length - 6, o = 0; t <= n; n -= 6) {
                        r = s(e, n, n + 6), this.words[o] |= r << i & 67108863, this.words[o + 1] |= r >>> 26 - i & 4194303, 26 <= (i += 24) && (i -= 26, o++);
                    }

                    n + 6 !== t && (r = s(e, t, n + 6), this.words[o] |= r << i & 67108863, this.words[o + 1] |= r >>> 26 - i & 4194303), this.strip();
                    ...
                    if (0 != s) {
                        for (var h = 1, u = f(e, l, e.length, t), l = 0; l < s; l++) {
                            h *= t;
                        }
                ...
                function i(e, t, r) {
                    ...
                    var n = e.length + t.length | 0,
                        n = (r.length = n) - 1 | 0,
                        i = 67108863 & (f = (0 | e.words[0]) * (0 | t.words[0])),
                        o = f / 67108864 | 0;
                    r.words[0] = i;
                ...
                m.prototype.toString = function(e, t) {
                    if (t = 0 | t || 1, 16 === (e = e || 10) || "hex" === e) {
                        ...
                        for (0 !== n && (a = n.toString(16) + a); a.length % t != 0;) {
                            a = "0" + a;
                        }
                    ...
                    if (e === (0 | e) && 2 <= e && e <= 36) {
                        ...
                        for (a = "", (h = this.clone()).negative = 0; !h.isZero();) {
                            var h,
                                f = h.modn(l).toString(e);
                            a = (h = h.idivn(l)).isZero() ? f + a : c[u - f.length] + f + a;
                        }

                        for (this.isZero() && (a = "0" + a); a.length % t != 0;) {
                            a = "0" + a;
                        }
                    ...
                    for (var t, r = this.length > e.length ? (t = this, e) : (t = e, this), n = 0; n < r.length; n++) {
                ...
                var o = function o(e, t, r) {
                    ...
                    ye = ((o + Math.imul(k, pe) | 0) + (i >>> 13) | 0) + (Ie >>> 26) | 0, Ie &= 67108863, n = Math.imul(D, ie), i = Math.imul(D, oe) + Math.imul(U, ie) | 0, o = Math.imul(U, oe), n = n + Math.imul(C, ae) | 0, i = (i + Math.imul(C, ue) | 0) + Math.imul(L, ae) | 0, o = o + Math.imul(L, ue) | 0, n = n + Math.imul(T, he) | 0, i = (i + Math.imul(T, fe) | 0) + Math.imul(R, he) | 0, o = o + Math.imul(R, fe) | 0;
                    var Te = (ye + (n + Math.imul(x, de) | 0) | 0) + ((8191 & (i = (i + Math.imul(x, pe) | 0) + Math.imul(P, de) | 0)) << 13) | 0;
                    ye = ((o + Math.imul(P, pe) | 0) + (i >>> 13) | 0) + (Te >>> 26) | 0, Te &= 67108863, n = Math.imul(D, ae), i = Math.imul(D, ue) + Math.imul(U, ae) | 0, o = Math.imul(U, ue), n = n + Math.imul(C, he) | 0, i = (i + Math.imul(C, fe) | 0) + Math.imul(L, he) | 0, o = o + Math.imul(L, fe) | 0;
                    var Re = (ye + (n + Math.imul(T, de) | 0) | 0) + ((8191 & (i = (i + Math.imul(T, pe) | 0) + Math.imul(R, de) | 0)) << 13) | 0;
                    ye = ((o + Math.imul(R, pe) | 0) + (i >>> 13) | 0) + (Re >>> 26) | 0, Re &= 67108863, n = Math.imul(D, he), i = Math.imul(D, fe) + Math.imul(U, he) | 0, o = Math.imul(U, fe);
                    ...
                    var Ce = (ye + Math.imul(D, de) | 0) + ((8191 & (i = Math.imul(D, pe) + Math.imul(U, de) | 0)) << 13) | 0;
                ...
                Math.imul || (o = i), m.prototype.mulTo = function(e, t) {
                    var r = this.length + e.length,
                        n = (10 === this.length && 10 === e.length ? o : r < 63 ? i : r < 1024 ? function(e, t, r) {
                    ...
                    for (var r = 1 & (i = 1 | Math.max(t, e)), n = 0, i = i / 2 | 0; i; i >>>= 1) {
                        n++;
                    }
                    ...
                    var t,
                        r = e % 26,
                        n = (e - r) / 26;
                    return y(0 === this.negative, "imaskn works only with positive numbers"), this.length <= n ? this : (0 != r && n++, this.length = Math.min(n, this.length), 0 != r && (t = 67108863 ^ 67108863 >>> r << r, this.words[this.length - 1] &= t), this.strip());
                    ...
                    for (var o = 0, s = 0; s < e.length; s++) {
                        ...
                        var a = (0 | e.words[s]) * t,
                            o = ((n -= 67108863 & a) >> 26) - (a / 67108864 | 0);
                        this.words[s + r] = 67108863 & n;
                    }

                    for (; s < this.length - r; s++) {
                        o = (n = (0 | this.words[s + r]) + o) >> 26, this.words[s + r] = 67108863 & n;
                    }

                    if (0 === o) return this.strip();

                    for (y(-1 === o), s = o = 0; s < this.length; s++) {
                        o = (n = -(0 | this.words[s]) + o) >> 26, this.words[s] = 67108863 & n;
                    }
                    ...
                    for (var t = this, r = e.clone(), t = 0 !== t.negative ? t.umod(e) : t.clone(), n = new m(1), i = new m(0), o = new m(0), s = new m(1), a = 0; t.isEven() && r.isEven();) {
                    ...
                    var t,
                        r,
                        n = e < 0;
                    return 0 === this.negative || n ? 0 === this.negative && n ? 1 : (this.strip(), r = 1 < this.length ? 1 : (n && (e = -e), y(e <= 67108863, "Number is too big"), (t = 0 | this.words[0]) === e ? 0 : t < e ? -1 : 1), 0 !== this.negative ? 0 | -r : r) : -1;
                ...
                h.prototype._tmp = function() {
                    ...
                    for (var o = new m(1).toRed(this), s = o.redNeg(), a = this.m.subn(1).iushrn(1), u = new m(2 * (u = this.m.bitLength()) * u).toRed(this); 0 !== this.pow(u, a).cmp(s);) {
                        u.redIAdd(s);
                    }
        ...
        13: [function(e, t, r) {
            ...
            (t.exports = o).prototype.point = function() {
                ...
                for (var o = [], s = 0; s < n.length; s += r.step) {
                    for (var a = 0, t = s + r.step - 1; s <= t; t--) {
                        a = (a << 1) + n[t];
                    }
                ...
                for (l = n - 1; 1 <= l; l -= 2) {
                    ...
                    if (1 === o[f] && 1 === o[c]) {
                        ...
                        a[f] = new Array(u), a[c] = new Array(u);
                ...
                for (var b = this.jpoint(null, null, null), w = this._wnafT4, l = u; 0 <= l; l--) {
                    for (var _ = 0; 0 <= l;) {
        ...
        17: [function(e, t, r) {
            ...
            i(a, o), (t.exports = a).prototype._getEndomorphism = function(e) {
                var t, r, n, i;
                if (this.zeroA && this.g && this.n && 1 === this.p.modn(3)) return n = e.beta ? new _(e.beta, 16).toRed(this.red) : (n = (r = this._getEndoRoots(this.p))[0].cmp(r[1]) < 0 ? r[0] : r[1]).toRed(this.red), e.lambda ? t = new _(e.lambda, 16) : (i = this._getEndoRoots(this.n), 0 === this.g.mul(i[0]).x.cmp(this.g.x.redMul(n)) ? t = i[0] : (t = i[1], s(0 === this.g.mul(t).x.cmp(this.g.x.redMul(n))))), {
                    beta: n,
                    lambda: t,
                ...
                for (var t, r, n, i, o, s, a, u = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), l = e, h = this.n.clone(), f = new _(1), c = new _(0), d = new _(0), p = new _(1), v = 0; 0 !== l.cmpn(0);) {
                    var y = h.div(l),
                        m = h.sub(y.mul(l)),
                        g = d.sub(y.mul(f)),
                        b = p.sub(y.mul(c));
                    if (!n && m.cmp(u) < 0) t = a.neg(), r = f, n = m.neg(), i = g;
                    else if (n && 2 == ++v) break;
                    h = l, l = a = m, d = f, f = g, p = c, c = b;
                }
                ...
                if (this.curve.endo) {
                    ...
                    return e && (t = this.curve, r = function r(e) {
                ...
                var t,
                    r,
                    n = this.curve.point(this.x, this.y.redNeg());
                return e && this.precomputed && (t = this.precomputed, r = function r(e) {
                    return e.neg();
                }, n.precomputed = {
                    naf: t.naf && {
                        wnd: t.naf.wnd,
                ...
                for (var n = this.curve.a, i = this.curve.tinv, o = this.x, s = this.y, a = this.z, u = a.redSqr().redSqr(), l = s.redAdd(s), r = 0; r < e; r++) {
                    var h = o.redSqr(),
                        f = l.redSqr(),
                        c = f.redSqr(),
        ...
        21: [function(e, t, r) {
            ...
            function i(e, t) {
                ...
                this._importDER(e, t) || (n(e.r && e.s, "Signature without r or s"), this.r = new u(e.r, 16), this.s = new u(e.s, 16), void 0 === e.recoveryParam ? this.recoveryParam = null : this.recoveryParam = e.recoveryParam);
            }
            ...
            (t.exports = i).prototype._importDER = function(e, t) {
                ...
                return this.r = new u(o), this.s = new u(a), !(this.recoveryParam = null);
                ...
                var n = [2];
                a(n, t.length), (n = n.concat(t)).push(2), a(n, r.length);
                var i = n.concat(r),
                    o = [48];
                return a(o, i.length), o = o.concat(i), l.encode(o, e);
            };
        }, {
            "../utils": 24,
            "bn.js": 9
        ...
        29: [function(e, t, r) {
            ...
            n.inherits(s, o), (r.ripemd160 = s).blockSize = 512, s.outSize = 160, s.hmacStrength = 192, s.padLength = 64, s.prototype._update = function(e, t) {
                for (var r, n, i = f = this.h[0], o = v = this.h[1], s = p = this.h[2], a = d = this.h[3], u = c = this.h[4], l = 0; l < 80; l++) {
                    var h = m(y(b(f, w(l, v, p, d), e[_[l] + t], (n = l) <= 15 ? 0 : n <= 31 ? 1518500249 : n <= 47 ? 1859775393 : n <= 63 ? 2400959708 : 2840853838), A[l]), c),
                        f = c,
                        c = d,
                        d = y(p, 10),
                        p = v,
                        v = h,
                        h = m(y(b(i, w(79 - l, o, s, a), e[M[l] + t], (r = l) <= 15 ? 1352829926 : r <= 31 ? 1548603684 : r <= 47 ? 1836072691 : r <= 63 ? 2053994217 : 0), E[l]), u),
                        i = u,
                        u = a,
                        a = y(s, 10),
                        s = o,
                ...
                h = g(this.h[1], p, a), this.h[1] = g(this.h[2], d, u), this.h[2] = g(this.h[3], c, i), this.h[3] = g(this.h[4], f, o), this.h[4] = g(this.h[0], v, s), this.h[0] = h;
        ...
        35: [function(e, t, r) {
            ...
            n.inherits(a, o), (t.exports = a).blockSize = 1024, a.outSize = 512, a.hmacStrength = 192, a.padLength = 128, a.prototype._prepareBlock = function(e, t) {
                ...
                for (; n < r.length; n += 2) {
                    ...
                    r[n] = p(i, o, s, a, u, l, h, f), r[n + 1] = v(i, o, s, a, u, l, h, f);
                }
                ...
                for (var b = 0; b < r.length; b += 2) {
                    var w = m,
                        ...
                        x = r[b],
                        P = r[b + 1],
                        I = j(w, _, M, A, E, S, k, N, x, P),
                        T = G(w, _, M, A, E, S, k, N, x, P),
                        w = function(e, t) {
                            var r = L(e, t, 28),
                                n = L(t, e, 2),
                                i = L(t, e, 7),
                ...
                D(this.h, 0, n, i), D(this.h, 2, o, s), D(this.h, 4, a, u), D(this.h, 6, l, h), D(this.h, 8, f, c), D(this.h, 10, d, p), D(this.h, 12, v, y), D(this.h, 14, m, g);
        ...
        37: [function(e, t, r) {
            ...
            r.inherits = n, r.toArray = function(e, t) {
                ...
                for (var o = new Array(i / 4), s = 0, a = t; s < o.length; s++, a += 4) {
                    var u = "big" === n ? e[a] << 24 | e[a + 1] << 16 | e[a + 2] << 8 | e[a + 3] : e[a + 3] << 24 | e[a + 2] << 16 | e[a + 1] << 8 | e[a];
                    o[s] = u >>> 0;
                }
        ...
        39: [function(e, t, r) {
            "function" == typeof Object.create ? t.exports = function(e, t) {
                ...
                var r;
                t && (e.super_ = t, (r = function r() {}).prototype = t.prototype, e.prototype = new r(), e.prototype.constructor = e);
            };
        }, {}],
        40: [function(e, _, t) {
            (function(b, w) {
        ...
        44: [function(e, r, o) {
            (function(n) {
                ...
                function l(e) {
                    ...
                    function t(e) {
                        for (var t = 0, r = e.length; 64 <= r;) {
                            for (var n, i, o, s, a = m, u = g, l = b, h = w, f = _, c = M, d = A, p = E, v = 0; v < 16; v++) {
                                i = t + 4 * v, S[v] = (255 & e[i]) << 24 | (255 & e[i + 1]) << 16 | (255 & e[i + 2]) << 8 | 255 & e[i + 3];
                            }

                            for (v = 16; v < 64; v++) {
                                o = ((n = S[v - 2]) >>> 17 | n << 15) ^ (n >>> 19 | n << 13) ^ n >>> 10, s = ((n = S[v - 15]) >>> 7 | n << 25) ^ (n >>> 18 | n << 14) ^ n >>> 3, S[v] = (o + S[v - 7] | 0) + (s + S[v - 16] | 0) | 0;
                            }

                            for (v = 0; v < 64; v++) {
                                o = (((f >>> 6 | f << 26) ^ (f >>> 11 | f << 21) ^ (f >>> 25 | f << 7)) + (f & c ^ ~f & d) | 0) + (p + (y[v] + S[v] | 0) | 0) | 0, s = ((a >>> 2 | a << 30) ^ (a >>> 13 | a << 19) ^ (a >>> 22 | a << 10)) + (a & u ^ a & l ^ u & l) | 0, p = d, d = c, c = f, f = h + o | 0, h = l, l = u, u = a, a = o + s | 0;
                            }

                            m = m + a | 0, g = g + u | 0, b = b + l | 0, w = w + h | 0, _ = _ + f | 0, M = M + c | 0, A = A + d | 0, E = E + p | 0, t += 64, r -= 64;
                        }
                    }
                ...
                function P(e, t, r) {
                    ...
                    for (var n = 64 + t.length + 4, i = new Array(n), o = new Array(64), s = [], a = 0; a < 64; a++) {
                        i[a] = 54;
                    }
                    ...
                    for (; 32 <= r;) {
                        u(), s = s.concat(l(o.concat(l(i)))), r -= 32;
                    }
                ...
                function e(o, e, s, a, u, l, h) {
                    ...
                    if (s = O(s, "N"), a = O(a, "r"), u = O(u, "p"), l = O(l, "dkLen"), 0 === s || 0 != (s & s - 1)) throw new Error("N must be power of 2");
                    if (C / 128 / a < s) throw new Error("N too large");
                    if (C / 128 / u < a) throw new Error("r too large");
                    if (!i(o)) throw new Error("password must be an array or buffer");
                    if (o = Array.prototype.slice.call(o), !i(e)) throw new Error("salt must be an array or buffer");
                ...
                var t, C;
                t = this, C = 2147483647, void 0 !== o ? r.exports = e : t && (t.scrypt && (t._scrypt = t.scrypt), t.scrypt = e);
        ...
        45: [function(e, t, r) {
            (function(y, e, t) {
                ! function(r, n) {
                    ...
                    var t, i, o, s, e, a, u, l, h;

                    function f(e) {
                        return i[t] = c.apply(n, e), t++;
                    }
                    ...
                    function v(e) {
                        e.source === r && "string" == typeof e.data && 0 === e.data.indexOf(l) && d(+e.data.slice(l.length));
                    }

                    r.setImmediate || (t = 1, o = !(i = {}), s = r.document, h = (h = Object.getPrototypeOf && Object.getPrototypeOf(r)) && h.setTimeout ? h : r, e = "[object process]" === {}.toString.call(r.process) ? function() {
                        var e = f(arguments);
                    ...
                    }() ? (l = "setImmediate$" + Math.random() + "$", r.addEventListener ? r.addEventListener("message", v, !1) : r.attachEvent("onmessage", v), function() {
                        var e = f(arguments);
                        return r.postMessage(l + e, "*"), e;
                    }) : r.MessageChannel ? ((u = new MessageChannel()).port1.onmessage = function(e) {
                        d(e.data);
                    }, function() {
                        var e = f(arguments);
                        return u.port2.postMessage(e), e;
                    }) : s && "onreadystatechange" in s.createElement("script") ? (a = s.documentElement, function() {
                        var e = f(arguments),
                            t = s.createElement("script");
                        return t.onreadystatechange = function() {
                            d(e), t.onreadystatechange = null, a.removeChild(t), t = null;
                        }, a.appendChild(t), e;
                    }) : function() {
                        var e = f(arguments);
        ...
        47: [function(e, i, t) {
            (function(e) {
                var t, r, n;
                e.crypto && crypto.getRandomValues && (t = new Uint8Array(16), r = function r() {
                    return crypto.getRandomValues(t), t;
                }), r || (n = new Array(16), r = function r() {
        ...
        51: [function(e, t, r) {
            ...
            var K,
                            ...
                            return y.poll(function() {
                                return o.perform("getTransactionReceipt", t).then(function(e) {
                                    ...
                                    if (null != e.blockHash) {
                                        var t,
                                            r,
                                            n = ((r = b(C, t = e)).logs.forEach(function(e, t) {
                    ...
                    return this.ready.then(function() {
                        return c.resolveProperties(e).then(function(e) {
                            return n._resolveNames(e, ["address"]).then(function(e) {
                                var t,
                                    r = {
                                        filter: (t = e) && t.blockHash ? b(D, t) : b(B, t)
                                    };
                ...
                }, W.checkTransactionResponse = N, W.prototype.doPoll = function() {}, W.prototype.perform = function(e, t) {
        ...
        52: [function(e, t, r) {
            ...
            var v,
                y = "8FG3JMZ9USS4NTA6YKEKHINU56SEPPVBJR",
                m = (v = s.BaseProvider, i(g, v), g.prototype.perform = function(e, t) {
                    var r = this,
                        n = this.baseUrl,
                        i = "";
        ...
        55: [function(e, t, r) {
            ...
            var s,
                ...
                d = (s = a.JsonRpcProvider, i(p, s), p.prototype._startPending = function() {
        ...
        57: [function(e, t, r) {
            ...
            var m,
                ...
                w = (m = a.Signer, i(_, m), _.prototype.getAddress = function() {
                    ...
                    e = c.shallowCopy(e);
                    var t,
                        r = this.getAddress().then(function(e) {
            ...
            var M,
                ...
                E = (M = s.BaseProvider, i(S, M), S.prototype.getSigner = function(e) {
                    ...
                    return ["gasLimit", "gasPrice", "nonce", "value"].forEach(function(e) {
                        var t;
                        null != r[e] && (t = h.hexStripZeros(h.hexlify(r[e])), "gasLimit" === e && (e = "gas"), i[e] = t);
            ...
            function S(e, t) {
                var r,
                    n = this;
                return "string" == typeof e && null === t && f.getNetwork(e) && (t = e, e = null), n = t ? M.call(this, t) || this : (r = new Promise(function(t, r) {
                    setTimeout(function() {
        ...
        59: [function(e, t, r) {
            ...
            var x,
                P = (i(I, x = _), I.prototype.encode = function(t) {
                    ...
                    var r = 32 - this.size,
                        ...
                        n = this.signed ? n.fromTwos(8 * this.size) : n.maskn(8 * this.size);
                    return {
                        consumed: 32,
            ...
            var L,
                B = (i(D, L = _), D.prototype.encode = function(t) {
            ...
            function se(e, t) {
                ...
                var n,
                    ...
                    s,
                    a = t.type.match(p);
                if (a) return (0 === (u = parseInt(a[2] || "256")) || 256 < u || u % 8 != 0) && l.throwError("invalid " + a[1] + " bit length", l.INVALID_ARGUMENT, {
                    arg: "param",
                    value: t
                }), new P(e, u / 8, "int" === a[1], t.name);
                if (a = t.type.match(d)) return (0 === (u = parseInt(a[1])) || 32 < u) && l.throwError("invalid bytes length", l.INVALID_ARGUMENT, {
                    arg: "param",
                    value: t
                }), new B(e, u, t.name);

                if (a = t.type.match(v)) {
                    var u = parseInt(a[2] || "-1");
                    return (t = c.shallowCopy(t)).type = a[1], t = c.deepCopy(t), new Y(e, se(e, t), u, t.name);
                }

                return "tuple" === t.type.substring(0, 5) ? (n = e, i = t.components, o = t.name, s = [], (i = i || []).forEach(function(e) {
                    s.push(se(n, e));
                }), new re(n, s, o)) : "" === t.type ? new k(e, t.name) : (l.throwError("invalid type", l.INVALID_ARGUMENT, {
                    arg: "type",
                    value: t.type
                }), null);
            }
        ...
        64: [function(e, t, r) {
            ...
            function h(e) {
                if (null == e && a.throwError("cannot convert null value to array", a.INVALID_ARGUMENT, {
                        arg: "value",
                        value: e
                    }), s(e) && (e = e.toHexString()), "string" != typeof e) return l(e) ? u(new Uint8Array(e)) : (a.throwError("invalid arrayify value", null, {
                    arg: "value",
                    value: e,
                    type: typeof e
                }), null);
            ...
            function i(e) {
                ...
                for (var o = new Uint8Array(r), s = 0, n = 0; n < t.length; n++) {
            ...
            r.isHexable = s, r.isArrayish = l, r.arrayify = h, r.concat = i, r.stripZeros = function(e) {
                var t = h(e);
        ...
        69: [function(e, t, r) {
            ...
            var L = (B.prototype.parseTransaction = function(e) {
                ...
                return null;
            }, B.prototype.parseLog = function(e) {
                ...
                return null;
            }, B.isInterface = function(e) {
                return p.isType(e, "Interface");
            }, B.isIndexed = function(e) {
                return p.isType(e, "Indexed");
            }, B);

            function B(t) {
                if (v.checkNew(this, B), "string" == typeof t) {
                    try {
                        t = JSON.parse(t);
                    } catch (e) {
        ...
        78: [function(e, t, r) {
            ...
            r.decryptCrowdsale = function(e, t) {
                ...
                for (var o = w.pbkdf2(t, t, 2e3, 32, "sha256").slice(0, 16), s = i.slice(0, 16), a = i.slice(16), u = new R.default.ModeOfOperation.cbc(o, s), l = L.arrayify(u.decrypt(a)), l = R.default.padding.pkcs7.strip(l), h = "", f = 0; f < l.length; f++) {
                    h += String.fromCharCode(l[f]);
                }

                var c = p.toUtf8Bytes(h),
                    d = new C.SigningKey(B.keccak256(c));
                ...
                function p(e, t) {
                    var r,
                        n,
                        i = _(M(m, "crypto/ciphertext"));

                    if (L.hexlify((r = e.slice(16, 32), n = i, B.keccak256(L.concat([r, n])))).substring(2) !== M(m, "crypto/mac").toLowerCase()) return t(new Error("invalid password")), null;

                    var o = function(e, t) {
                            if ("aes-128-ctr" !== M(m, "crypto/cipher")) return null;

                            var r = _(M(m, "crypto/cipherparams/iv")),
                    ...
                    var a = new C.SigningKey(o);
                    if (m.address && a.address !== b.getAddress(m.address)) return t(new Error("address mismatch")), null;
                    var u = M(m, "x-ethers/locale");

                    if ("0.1" === M(m, "x-ethers/version") && (null == u || "en" === u)) {
                        var l = _(M(m, "x-ethers/mnemonicCiphertext")),
                            h = _(M(m, "x-ethers/mnemonicCounter")),
                            f = new R.default.Counter(h),
                            c = new R.default.ModeOfOperation.ctr(s, f),
                            d = M(m, "x-ethers/path") || g.defaultPath,
                            p = L.arrayify(c.decrypt(l)),
                            v = g.entropyToMnemonic(p),
                            y = g.fromMnemonic(v).derivePath(d);

                        if (y.privateKey != L.hexlify(o)) return t(new Error("mnemonic mismatch")), null;
                        a = new C.SigningKey(y);
                    }
                ...
                return new Promise(function(i, o) {
                    var e = M(m, "crypto/kdf");
                    if (e && "string" == typeof e) {
                        if ("scrypt" === e.toLowerCase()) {
                            var t = _(M(m, "crypto/kdfparams/salt")),
                                r = parseInt(M(m, "crypto/kdfparams/n")),
                                n = parseInt(M(m, "crypto/kdfparams/r")),
                                s = parseInt(M(m, "crypto/kdfparams/p"));
                            ...
                            if (32 !== (l = parseInt(M(m, "crypto/kdfparams/dklen")))) return void o(new Error("unsupported key-derivation derived-key length"));
                            d && d(0), y.default(v, t, r, n, s, 64, function(e, t, r) {
                            ...
                            var l,
                                h = parseInt(M(m, "crypto/kdfparams/c"));
                            if (32 !== (l = parseInt(M(m, "crypto/kdfparams/dklen")))) return void o(new Error("unsupported key-derivation derived-key length"));
                            var f = w.pbkdf2(v, t, h, l, a),
                                c = p(f, o);
                            if (!c) return;
                            i(c);
                ...
                var E = w.path;
                A && !E && (E = g.defaultPath);
                var S = (S = w.client) || "ethers.js",
                    k = null,
                    k = w.salt ? L.arrayify(w.salt) : D.randomBytes(32),
                    N = null;
                    ...
                    _ && _(0), y.default(r, k, P, I, T, 64, function(e, t, r) {
                        if (e) e.progress = t, b(e);
                            ...
                            var n,
                                ...
                                a,
                                u,
                                l = (r = L.arrayify(r)).slice(0, 16),
                                h = r.slice(16, 32),
                                f = r.slice(32, 64),
                                c = new C.SigningKey(M).address,
                                d = new R.default.Counter(N),
                                p = new R.default.ModeOfOperation.ctr(l, d),
                                v = L.arrayify(p.encrypt(M)),
                                y = B.keccak256(L.concat([h, v])),
                                m = {
                                    address: c.substring(2).toLowerCase(),
                                    id: O.default.v4({
                                        random: x
                                    }),
                                    version: 3,
                                    Crypto: {
                                        ...
                                        ciphertext: L.hexlify(v).substring(2),
                                        kdf: "scrypt",
                                        kdfparams: {
                            ...
                            A && (n = D.randomBytes(16), i = new R.default.Counter(n), o = new R.default.ModeOfOperation.ctr(f, i), s = L.arrayify(o.encrypt(A)), u = (a = new Date()).getUTCFullYear() + "-" + U(a.getUTCMonth() + 1, 2) + "-" + U(a.getUTCDate(), 2) + "T" + U(a.getUTCHours(), 2) + "-" + U(a.getUTCMinutes(), 2) + "-" + U(a.getUTCSeconds(), 2) + ".0Z", m["x-ethers"] = {
                                client: S,
                                gethFilename: "UTC--" + u + "--" + m.address,
                                mnemonicCounter: L.hexlify(n).substring(2),
                                mnemonicCiphertext: L.hexlify(s).substring(2),
                                path: E,
                                version: "0.1"
                            }, w.wordlist && "string" == typeof w.wordlist.locale && (m["x-ethers"].locale = w.wordlist.locale)), _ && _(1), g(JSON.stringify(m));
        ...
        83: [function(e, t, r) {
            ...
            function p(e) {
                return "0x" === e ? i.Zero : h.bigNumberify(e);
            }
            ...
            r.serialize = function(r, e) {
                ...
                v.forEach(function(e) {
                    var t = r[e.name] || [],
                        t = f.arrayify(f.hexlify(t));
                    e.length && t.length !== e.length && 0 < t.length && a.throwError("invalid length for " + e.name, a.INVALID_ARGUMENT, {
                        arg: "transaction" + e.name,
                        value: t
                    }), e.maxLength && (t = f.stripZeros(t)).length > e.maxLength && a.throwError("invalid length for " + e.name, a.INVALID_ARGUMENT, {
                        arg: "transaction" + e.name,
                        value: t
                    }), n.push(f.hexlify(t));
                }), null != r.chainId && 0 !== r.chainId && (n.push(f.hexlify(r.chainId)), n.push("0x"), n.push("0x"));
                var t = d.encode(n);
                if (!e) return t;
                var i = f.splitSignature(e),
                    o = 27 + i.recoveryParam;
                return 9 === n.length && (n.pop(), n.pop(), n.pop(), o += 2 * r.chainId + 8), n.push(f.hexlify(o)), n.push(f.stripZeros(f.arrayify(i.r))), n.push(f.stripZeros(f.arrayify(i.s))), d.encode(n);
            }, r.parse = function(e) {
                var t = d.decode(e);
                ...
                var r,
                    n = {
                        ...
                        gasPrice: p(t[1]),
                        gasLimit: p(t[2]),
                        to: "0x" === (r = t[3]) ? null : l.getAddress(r),
                        value: p(t[4]),
                        data: t[5],
                        chainId: 0
                    };
                ...
                try {
                    n.v = h.bigNumberify(t[6]).toNumber();
                } catch (e) {
                    return a.info(e), n;
                }

                if (n.r = f.hexZeroPad(t[7], 32), n.s = f.hexZeroPad(t[8], 32), h.bigNumberify(n.r).isZero() && h.bigNumberify(n.s).isZero()) n.chainId = n.v, n.v = 0;
                else {
                    n.chainId = Math.floor((n.v - 35) / 2), n.chainId < 0 && (n.chainId = 0);
                    var i = n.v - 27,
                        o = t.slice(0, 6);
                    0 !== n.chainId && (o.push(f.hexlify(n.chainId)), o.push("0x"), o.push("0x"), i -= 2 * n.chainId + 8);
                ...
                var n,
                    i = s.shallowCopy(e);
                return null != i.to && (i.to = t.resolveName(i.to)), null == i.gasPrice && (i.gasPrice = t.getGasPrice()), null == i.nonce && (i.nonce = t.getTransactionCount(r)), null == i.gasLimit && ((n = s.shallowCopy(i)).from = r, i.gasLimit = t.estimateGas(n)), null == i.chainId && (i.chainId = t.getNetwork().then(function(e) {
                    return e.chainId;
                })), s.resolveProperties(i);
            };
        }, {
            "../constants": 3,
            "../errors": 5,
        ...
        84: [function(e, t, r) {
            ...
            function u(e, t) {
                ...
                for ((s = s || "0").length > r.decimals && f.throwError("underflow occurred", f.NUMERIC_FAULT, {
                        operation: "division",
                        fault: "underflow"
                    }); s.length < r.decimals;) {
                    s += "0";
            ...
            r.fetchJson = function(e, a, u) {
                ...
                return new Promise(function(n, i) {
                    ...
                    a ? (s.open("POST", l, !0), r["content-type"] = {
                        ...
                        var t = r[e];
                        s.setRequestHeader(t.key, t.value);
                ...
                return l = l || {}, null == (l = o.shallowCopy(l)).floor && (l.floor = 0), null == l.ceiling && (l.ceiling = 1e4), null == l.interval && (l.interval = 250), new Promise(function(n, t) {
                    ...
                    ! function r() {
                        return u().then(function(e) {
                            var t;
                            return void 0 !== e ? o() && n(e) : l.onceBlock ? l.onceBlock.once("block", r) : i || (a++, (t = l.interval * parseInt(String(Math.random() * Math.pow(2, a)))) < l.floor && (t = l.floor), t > l.ceiling && (t = l.ceiling), s && (a--, t = s, s = null), setTimeout(r, t)), null;
                        }, function(e) {
                            o() && t(e);
                        });
                    }();
