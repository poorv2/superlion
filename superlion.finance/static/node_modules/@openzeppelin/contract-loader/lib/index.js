...
function localArtifactPath(contract, artifactsDir) {
    var buildDir = find_up_1.default.sync(artifactsDir, {
        type: 'directory'
    });
...
function loadArtifact(contract, artifactsDir) {
    var artifactPath = contract.includes('/') ? dependencyArtifactPath : function(c) {
        return localArtifactPath(c, artifactsDir);
    };
    return fs_extra_1.readJSONSync(artifactPath(contract), {
        encoding: 'utf8'
    });
}
...
var BaseLoader =
    ...
    function() {
        ...
        BaseLoader.prototype.fromArtifact = function(contract, address) {
            var _a = loadArtifact(contract, this.artifactsDir),
                abi = _a.abi,
                bytecode = _a.bytecode;
...
var TruffleLoader =
    ...
    function(_super) {
        ...
        TruffleLoader.prototype.fromABI = function(abi, bytecode, address) {
            ...
            var abstraction = this.truffleContract({
                abi: abi,
...
function setupLoader(_a) {
    var provider = _a.provider,
        defaultSender = _a.defaultSender,
        _b = _a.defaultGas,
        defaultGas = _b === void 0 ? DEFAULT_GAS : _b,
        _c = _a.defaultGasPrice,
        defaultGasPrice = _c === void 0 ? DEFAULT_GAS_PRICE : _c,
        artifactsDir = _a.artifactsDir;
    return {
