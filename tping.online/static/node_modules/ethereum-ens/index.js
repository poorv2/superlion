...
var supportedDecoders = _.reduce(_.keys(abiDecoders), function(memo, val) {
    return memo | val;
});
/**
    ...
    _.each(contract.methods, function(method, signature) {
        this[signature] = function() {
            ...
            return this.instancePromise.then(function(instance) {
                ...
                }, null); // Call if it's a constant method, send (with params) if it's not
                ...
                if (asyncObj === null) {
                    ...
                    return ens.web3.eth.getAccounts().then(function(accounts) {
                        return _.partial(instance.methods[signature], node).apply(instance.methods, args).send(params ? params : {
                            from: accounts[0]
                        });
                    });
                }
...
function ENS_1(provider, address) {
    ...
    if (address != undefined) {
        ...
        this.registryPromise = new Promise(function(resolve) {
...
ENS_1.prototype.setResolver = function(name, addr, params) {
    ...
    return this.registryPromise.then(function(registry) {
        return this.web3.eth.getAccounts().then(function(accounts) {
            return registry.methods.setResolver(node, addr).send(params ? params : {
                from: accounts[0]
            });
        });
    }.bind(this));
...
ENS_1.prototype.setOwner = function(name, addr, params) {
    ...
    return this.registryPromise.then(function(registry) {
        return this.web3.eth.getAccounts().then(function(accounts) {
            return registry.methods.setOwner(node, addr).send(params ? params : {
                from: accounts[0]
            });
        });
    }.bind(this));
...
ENS_1.prototype.setSubnodeOwner = function(name, addr, params) {
    ...
    return this.registryPromise.then(function(registry) {
        return this.web3.eth.getAccounts().then(function(accounts) {
            return registry.methods.setSubnodeOwner(node[1], node[0], addr).send(params ? params : {
                from: accounts[0]
            });
        });
    }.bind(this));
