...
function perl(hljs) {
    ...
    var REGEX_DELIMS = [/!/, /\//, /\|/, /\?/, /'/, /"/, // valid but infrequent and weird
    ...
    var PAIRED_DOUBLE_RE = function PAIRED_DOUBLE_RE(prefix, open) {
        ...
        var middle = close === '\\1' ? close : concat(close, open);
    ...
    var PERL_DEFAULT_CONTAINS = [VAR, hljs.HASH_COMMENT_MODE, hljs.COMMENT(/^=\w/, /=cut/, {
        ...
        contains: [hljs.HASH_COMMENT_MODE, {
            ...
            variants: [ // allow matching common delimiters
                {
                    begin: PAIRED_DOUBLE_RE("s|tr|y", either.apply(void 0, REGEX_DELIMS))
            ...
            variants: [{
                ...
                {
                    begin: PAIRED_RE("m|qr", either.apply(void 0, REGEX_DELIMS), /\1/)
