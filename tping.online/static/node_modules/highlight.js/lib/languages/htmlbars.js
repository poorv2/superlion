...
function handlebars(hljs) {
    ...
    var ANY_ID = either(DOUBLE_QUOTED_ID_REGEX, SINGLE_QUOTED_ID_REGEX, BRACKET_QUOTED_ID_REGEX, PLAIN_ID_REGEX);
    var IDENTIFIER_REGEX = concat(optional(/\.|\.\/|\//), // relative or absolute path
        ANY_ID, anyNumberOfTimes(concat(PATH_DELIMITER_REGEX, ANY_ID))); // identifier followed by a equal-sign (without the equal sign)

    var HASH_PARAM_REGEX = concat('(', BRACKET_QUOTED_ID_REGEX, '|', PLAIN_ID_REGEX, ')(?==)');
...
function htmlbars(hljs) {
    var definition = handlebars(hljs);
